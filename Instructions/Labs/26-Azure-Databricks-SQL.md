...
4. In the PowerShell pane, enter the following commands to clone this repo:
    ...
    git clone https://github.com/abhi0751/mslearn-databricks
    ```
...
1. Download the [`products.csv`](https://raw.githubusercontent.com/abhi0751/mslearn-databricks/main/data/products.csv) file to your local computer, saving it as **products.csv**.
