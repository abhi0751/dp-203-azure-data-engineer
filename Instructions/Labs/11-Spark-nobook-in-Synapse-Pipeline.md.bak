...
10 Then on **Develop** page, expand **Notebooks** click on the + Import options
    ![Spark Notebook import](./images/spark-notebook-import.png)
...
5. In the notebook toolbar, attach the notebook to your **spark*xxxxxxx*** Spark pool and then use the **&#9655; Run All** button to run all of the code cells in the notebook.
